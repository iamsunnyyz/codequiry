...
st.write("Account Information: {'user': 'Trilliant Networks Colombia SAS', 'email': 'felipe.urrego@trilliant.com', 'pro_checks_remaining': 300, 'submissions': 0}")
def print_lines():
    lines = [
        "　　"
        "Check Creation Response: {'course_id': 52727, 'name': 'Test Check', 'status_id': 1, 'job_id': 0, 'language_id': 18, 'updated_at': '2024-08-24 18:58:34', 'created_at': '2024-08-24 18:58:34', 'id': 95777}",
        'Raw Upload Response: {"data":[{"id":221004,"filename":"code-check","file_size":0,"status_id":2,"created_at":"2024-08-24 18:58:35","updated_at":"2024-08-24 18:58:35","result1":"0","result2":"0","result3":"0","total_result":"0","matches_local":0,"matches_web":0,"modify_updated_at":"Jul 30, 2024 6:58 PM UTC","assignmentstatuses":{"id":2,"status":"Ready","icon":"fas fa-step-forward","color":"primary","created_at":null,"updated_at":null}}],"file":"code-check.zip","submission_count":1,"check":{"id":95777,"course_id":52727,"name":"Test Check","created_at":"2024-08-24 18:58:34","updated_at":"2024-08-24 18:58:36","status_id":2,"job_id":0,"status_message":"","test_type":1,"language_id":18,"consumption":0,"consumption_per_line":"0.00000","prelim":1,"files":0,"lines":0,"sources_indexed":null,"billable_lines":null,"similar_files":0,"matches_found":0,"hard_comparisons":0}}',
        ...
        Created At: 2024-08-24 18:58:34
        ...
        Probability of Plagiarism: 87%

        Uniqueness Percentage: 13%
